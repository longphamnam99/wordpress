...
if ( ! function_exists( 'zakra_header_top' ) ) :
	...
	function zakra_header_top() {
		if ( ( false === get_theme_mod( 'zakra_header_top_enabled', false ) || ( 'none' === get_theme_mod( 'zakra_header_top_left_content', 'text_html' ) && 'none' === get_theme_mod( 'zakra_header_top_right_content', 'text_html' ) ) ) ) {
			return;
		}
